// Generated by gencpp from file traj_utils/polynomial.msg
// DO NOT EDIT!


#ifndef TRAJ_UTILS_MESSAGE_POLYNOMIAL_H
#define TRAJ_UTILS_MESSAGE_POLYNOMIAL_H
...
struct polynomial_
{
  ...
  typedef boost::shared_ptr< ::traj_utils::polynomial_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::traj_utils::polynomial_<ContainerAllocator> const> ConstPtr;

}; // struct polynomial_

typedef ::traj_utils::polynomial_<std::allocator<void> > polynomial;

typedef boost::shared_ptr< ::traj_utils::polynomial > polynomialPtr;
typedef boost::shared_ptr< ::traj_utils::polynomial const> polynomialConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::traj_utils::polynomial_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::traj_utils::polynomial_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::traj_utils::polynomial_<ContainerAllocator1> & lhs, const ::traj_utils::polynomial_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::traj_utils::polynomial_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::traj_utils::polynomial_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::traj_utils::polynomial_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::traj_utils::polynomial_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::traj_utils::polynomial_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::traj_utils::polynomial_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::traj_utils::polynomial_<ContainerAllocator> >
{
  ...
  static const char* value(const ::traj_utils::polynomial_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xfc5028b9e68e7966ULL;
  static const uint64_t static_value2 = 0xd83027aa556694ffULL;
};

template<class ContainerAllocator>
struct DataType< ::traj_utils::polynomial_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::traj_utils::polynomial_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::traj_utils::polynomial_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::traj_utils::polynomial_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::traj_utils::polynomial_<ContainerAllocator>& v)
  {
    s << indent << "drone_id: ";
...
#endif // TRAJ_UTILS_MESSAGE_POLYNOMIAL_H
